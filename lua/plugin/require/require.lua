...
return {
    ...
    -- require 'plugin.require.ui.dressing_nvim', -- UI增强: 改进原生UI组件
    ...
    require 'plugin.require.tool.ai.fittencode', -- Fitten Code: AI代码补全
    ...
    require 'plugin.require.tool.opencode', -- OpenCode: OpenCode AI集成
